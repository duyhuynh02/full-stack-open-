...
const Blog = ({ blog, handleLikes }) => {
  ...
  const hideBlogDetailWhenVisible = { display: blogDetailVisible ? 'none' : '' }
  const showBlogDetailWhenVisible = { display: blogDetailVisible ? '' : 'none' }
  ...
  return (
    <div className='allBlog'>
      ...
      <div style={hideBlogDetailWhenVisible}>
        ...
        <button id='show-detail' onClick={SetHideBlockDetailVisible} className="showDetail">show detail</button>
      </div>
      ...
      <div style={showBlogDetailWhenVisible}>
        <div style={blogStyle} className="blog">
          ...
          <div>{blog.url}</div>
          <div>{blogLikes}
            <button className='likes' onClick={handleLikesAndUpdate}>likes</button>
          </div>
          <div>{blog.user.username}</div>
          <button id="remove" onClick={removeBlog}>remove</button>
        </div>

        <button id='hide-detail' onClick={SetShowBlockDetailVisible}>hide detail</button>
      </div>
    </div>
