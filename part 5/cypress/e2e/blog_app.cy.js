describe('Blog App', () => {
  ...
  describe('when logged in', function() {
    ...
    it('A blog can be created', function() {
      ...
      cy.get('[placeholder="write title of blog here"]').type('How to launder your money?')
      cy.get('[placeholder="write author of blog here"]').type('Jonah Byrde')
      cy.get('[placeholder="write url of blog here"]').type('http://fullstackopen.com')
  ...
  describe('blogs are ordered according to likes', function() {
    beforeEach(function() {
      ...
      //first blog, 3 likes
      cy.contains('create new note').click()
      cy.get('[placeholder="write title of blog here"]').type('How to launder money?')
      cy.get('[placeholder="write author of blog here"]').type('Jonah Byrde')
      cy.get('[placeholder="write url of blog here"]').type('http://fullstackopen.com')
      cy.get('#create-button').click()
      ...
      //2nd blog, 7 likes. 
      cy.contains('create new note').click()
      cy.get('[placeholder="write title of blog here"]').type('Ozark is a good show, no?')
      cy.get('[placeholder="write author of blog here"]').type('Marty Byrde')
      cy.get('[placeholder="write url of blog here"]').type('http://ozarks.com')
      cy.get('#create-button').click()
      ...
      //3rd blog, 4 likes
      cy.contains('create new note').click()
      cy.get('[placeholder="write title of blog here"]').type('Wendy is such a hypocrite')
